...
import com.dicoding.picodiploma.moviecatalogueapi.viewmodel.TVShowFavoriteFragmentViewModel;
...
public class TVShowFavoriteFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final TVShowFavoriteFragmentViewModel tvShowFavoriteFragmentViewModel = new ViewModelProvider(this, new ViewModelProvider.NewInstanceFactory()).get(TVShowFavoriteFragmentViewModel.class);
        tvShowFavoriteFragmentViewModel.setFavorite(context);

        tvShowFavoriteFragmentViewModel.getFavorite().observe(this, new Observer<ArrayList<Favorite>>() {
            @Override
